...
ActiveRecord::Schema.define(version: 20_210_314_064_230) do
  ...
  create_table 'likes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[user_id output_id], name: 'index_likes_on_user_id_and_output_id', unique: true
  ...
  create_table 'participants', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[user_id meeting_id], name: 'index_participants_on_user_id_and_meeting_id', unique: true
  ...
  create_table 'requestings', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[user_id meeting_id], name: 'index_requestings_on_user_id_and_meeting_id', unique: true
